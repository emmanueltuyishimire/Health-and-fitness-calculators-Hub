          ...
          <CardContent>
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent>This calculator provides context to your body fat percentage. First you need the number itself, which you can get from our <a href="/body-fat" className="text-primary hover:underline">Body Fat Percentage Calculator</a>. This tool then tells you what that number means.</AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent>The <a href="/obesity-risk" className="text-primary hover:underline">Obesity Risk Calculator</a> uses BMI, which is a measure of weight relative to height. This calculator uses body fat percentage, which is a more accurate measure of body composition. You can have a "Normal" BMI but still be in the "Obese" body fat zone.</AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-5">
                <AccordionTrigger>How can I move from the "Obese" or "Acceptable" zone to the "Fitness" zone?</AccordionTrigger>
                <AccordionContent>To lower your body fat percentage, you need to create a sustainable <a href="/calorie-deficit" className="text-primary hover:underline">calorie deficit</a> and engage in regular exercise, particularly resistance training to build or maintain muscle. Use our <a href="/tdee" className="text-primary hover:underline">TDEE Calculator</a> to find your starting calorie target.</AccordionContent>
              </AccordionItem>
            </Accordion>
          </CardContent>
        </Card>
