...
export default function BmrPage() {
  ...
  return (
    <CalculatorCard
      ...
      description="Calculate your Basal Metabolic Rate (BMR) - the number of calories your body needs at rest."
      result={
        bmrResult !== null && (
          <div className="space-y-2">
            <h3 className="font-semibold text-foreground">Your BMR</h3>
