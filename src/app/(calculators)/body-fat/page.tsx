...
export default function BodyFatPage() {
  ...
  const handleSelectChange = (name: keyof BodyFatFormValues) => (value: string) => {
      ...
      result={
        bodyFatResult !== null && (
          <div className="space-y-2">
            <h3 className="font-semibold text-foreground">Your Estimated Body Fat</h3>
            <p className="text-3xl font-bold text-primary">
              {bodyFatResult.toFixed(1)}%
            </p>
            <p className="text-xs">
              This is an estimation. For accurate results, consult a healthcare professional.
            </p>
          </div>
        )
      }
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="number" placeholder="e.g., 80" {...field} onChange={handleInputChange} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Neck ({state.unitSystem === 'metric' ? 'cm' : 'in'})</FormLabel>
                  <FormControl>
                    <Input type="number" placeholder="e.g., 38" {...field} onChange={handleInputChange} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" placeholder="e.g., 95" {...field} onChange={handleInputChange} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          <Button type="submit" className="w-full sm:w-auto">Calculate Body Fat</Button>
        </form>
      </Form>
    </CalculatorCard>
  );
