    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Your daily calorie needs, or TDEE (Total Daily Energy Expenditure), is an estimation of how many calories you burn per day when exercise and other activities are taken into account. It is the key to setting your calorie intake for weight management. TDEE is calculated from your <a href="/bmr">BMR (Basal Metabolic Rate)</a>.',
        },
      },
      {
        '@type': 'Question',
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Your Daily Calorie Needs, or TDEE (Total Daily Energy Expenditure), is the total number of calories you burn in a day. It's the most crucial starting point for any weight management goal. First, calculate your <Link href="/bmr" className="text-primary hover:underline">BMR</Link>, then use this tool to find your maintenance calories and set precise targets for your goals.
                </p>
              </div>
            </div>
          </CardHeader>
