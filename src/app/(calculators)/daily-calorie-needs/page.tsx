...
import { DailyCalorieNeedsCalculatorForm } from '@/components/daily-calorie-needs-calculator-form';

export const metadata: Metadata = {
  title: 'Daily Calorie Needs Calculator – Your TDEE',
  description:
    'Calculate your Total Daily Energy Expenditure (TDEE) to discover your daily maintenance calories. Use this crucial metric to set accurate goals for weight loss, gain, or maintenance.',
  openGraph: {
    title: 'Daily Calorie Needs Calculator – Your TDEE',
    description:
      'Calculate your Total Daily Energy Expenditure (TDEE) to discover your daily maintenance calories. Use this crucial metric to set accurate goals for weight loss, gain, or maintenance.',
...
export default function DailyCalorieNeedsPage() {
  const jsonLd = {
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'What are Daily Calorie Needs (TDEE)?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Your daily calorie needs, or TDEE (Total Daily Energy Expenditure), is an estimation of how many calories you burn per day when exercise and other activities are taken into account. It is the key to setting your calorie intake for weight management. TDEE is calculated from your <a href="/bmr" aria-label="BMR Calculator">BMR (Basal Metabolic Rate)</a>.',
        },
      },
      {
        '@type': 'Question',
        name: 'How do I use my calorie needs for weight loss?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'To lose weight, you need to consume fewer calories than your TDEE. This is called a calorie deficit. A common deficit is 500 calories per day to lose about 1 pound per week. You can plan this with the <a href="/calorie-deficit" aria-label="Calorie Deficit Calculator">Calorie Adjustment for Weight Loss</a>.',
        },
      },
      {
        '@type': 'Question',
        name: 'How do I use my calorie needs for muscle gain?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'To gain muscle, you need to consume more calories than your TDEE (a <a href="/calorie-surplus" aria-label="Calorie Surplus Calculator">calorie surplus</a>) and engage in resistance training. A surplus of 250-500 calories is a good starting point to promote muscle growth while minimizing fat gain. You can track muscle growth with the <a href="/ffmi" aria-label="FFMI Calculator">FFMI Calculator</a>.',
        },
      },
      {
        '@type': 'Question',
      ...
      <div className="w-full max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 space-y-8">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Daily Calorie Needs Calculator</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Your Daily Calorie Needs, or TDEE (Total Daily Energy Expenditure), is the total number of calories you burn in a day. It's the most crucial starting point for any weight management goal. First, calculate your <Link href="/bmr" className="text-primary hover:underline" aria-label="BMR Calculator">BMR</Link>, then use this tool to find your maintenance calories and set precise targets for your goals.
                </p>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <DailyCalorieNeedsCalculatorForm />
          </CardContent>
        </Card>

        <Card>
          <CardHeader>
            <CardTitle>How to Use the Daily Calorie Needs Calculator</CardTitle>
          </CardHeader>
          ...
          <CardContent>
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger>What are Daily Calorie Needs (TDEE)?</AccordionTrigger>
              ...
              <AccordionItem value="item-2">
                <AccordionTrigger>How do I use my calorie needs for weight loss?</AccordionTrigger>
              ...
              <AccordionItem value="item-3">
                <AccordionTrigger>How do I use my calorie needs for muscle gain?</AccordionTrigger>
