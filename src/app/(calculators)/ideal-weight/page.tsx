    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'No single formula is universally "most accurate" as they are all based on population averages. The Robinson and Miller formulas are often preferred in clinical settings. The best approach is to consider the average of all formulas as a healthy range. Then, use our <a href="/body-fat">Body Fat Percentage Calculator</a> to get a clearer picture of your composition.',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'The range accounts for individual differences in body frame, genetics, and muscle mass. A single number is too restrictive. Viewing it as a range promotes a healthier perspective on weight. Once you know your range, you can calculate your <a href="/bmr">BMR</a> to understand your metabolic baseline.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'No, these formulas are designed for adults. For children and teens, growth charts and <a href="/bmi">BMI percentiles</a> are used by pediatricians to assess healthy development.',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Not necessarily. Being slightly outside the range isn\'t automatically unhealthy, especially if you have a healthy <a href="/body-fat">body fat percentage</a> and lead an active lifestyle. These are guidelines, not strict rules. It\'s a good prompt to check other metrics like your <a href="/bmi">BMI</a>.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'You can estimate it by measuring your wrist circumference or elbow breadth. However, this is often subjective. A more practical approach is to focus on metrics you can change, like your <a href="/body-fat">body fat percentage</a> and overall fitness.',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Men and women have different body compositions on average. Men tend to have more muscle mass and bone density, which is reflected in the formulas. These differences also affect metabolic rate, which you can explore with the <a href="/bmr">BMR Calculator</a>.',
        },
      },
    ],
  };
      ...
      <div className="w-full max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 space-y-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                    Discover your healthy weight range with our Ideal Body Weight (IBW) Calculator. This tool provides an estimate based on your height and gender using several popular formulas. While it's a great starting point, remember to consider it alongside other metrics like the <Link href="/bmi" className="text-primary hover:underline">BMI Calculator</Link> and <Link href="/body-fat" className="text-primary hover:underline">Body Fat Percentage Calculator</Link> for a complete health picture.
                </p>
              </div>
            </div>
          </CardHeader>
              ...
              <TableBody>
                ...
                <TableRow>
                 ...
                 <TableRow>
                    ...
                    <TableCell>Compare this to her <Link href="/bmi" className="text-primary hover:underline">BMI</Link> to ensure it's in the normal range.</TableCell>
                    <TableCell>Calculate his <Link href="/bmr" className="text-primary hover:underline">BMR</Link> to understand his baseline metabolism at this weight.</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <p>The primary limitation of all IBW formulas is that they do not account for body composition. They can't tell the difference between a pound of muscle and a pound of fat. A bodybuilder, for example, might be classified as "overweight" by these formulas despite having a very low and healthy <Link href="/body-fat" className="text-primary hover:underline">body fat percentage</Link>. Conversely, a sedentary person could be within their "ideal weight" range but have low muscle mass and high body fat, a condition sometimes called "normal weight obesity."</p>
        ...
        <Card>
            ...
            <CardContent>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                    ...
                    <li><strong>Ignoring Body Composition:</strong> As mentioned, muscle is denser than fat. If you lift weights, you may be healthy even if you are above your "ideal" weight. Always check your <Link href="/body-fat" className="text-primary hover:underline">body fat percentage</Link>.</li>
                    ...
                    <li><strong>Applying it to Children:</strong> These formulas are for fully grown adults. Use a <Link href="/bmi" className="text-primary hover:underline">BMI percentile calculator</Link> for children and teens.</li>
                </ul>
            </CardContent>
        </Card>
          ...
          <CardContent>
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>No single formula is universally "most accurate." The best approach is to consider the average as a healthy range. Then, use our <Link href="/body-fat" className="text-primary hover:underline">Body Fat Percentage Calculator</Link> for a clearer picture.</AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent>The range accounts for differences in body frame, genetics, and muscle mass. A single number is too restrictive. Once you know your range, you can calculate your <Link href="/bmr" className="text-primary hover:underline">BMR</Link> to understand your metabolic baseline.</AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-5">
                <AccordionTrigger>Do these formulas work for children and teenagers?</AccordionTrigger>
                <AccordionContent>No, these formulas are for adults. For children, <Link href="/bmi" className="text-primary hover:underline">BMI percentiles</Link> are used by pediatricians.</AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-7">
                ...
                <AccordionContent>Not necessarily, especially if you have a healthy <Link href="/body-fat" className="text-primary hover:underline">body fat percentage</Link>. It's a good prompt to check other metrics like your <Link href="/bmi" className="text-primary hover:underline">BMI</Link>.</AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-8">
                <AccordionTrigger>How do I determine my body frame size?</AccordionTrigger>
                <AccordionContent>You can estimate it with wrist measurements, but it's often subjective. A better approach is to focus on metrics you can change, like your <Link href="/body-fat" className="text-primary hover:underline">body fat percentage</Link>.</AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-10">
                ...
                <AccordionContent>Men and women have different average body compositions (muscle vs. fat), which the formulas reflect. These differences also affect metabolic rate, which you can explore with the <Link href="/bmr" className="text-primary hover:underline">BMR Calculator</Link>.</AccordionContent>
              </AccordionItem>
            </Accordion>
          </CardContent>
        </Card>
