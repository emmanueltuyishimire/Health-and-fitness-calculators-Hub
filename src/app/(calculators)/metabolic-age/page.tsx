        ...
        <Card>
          ...
          <CardContent>
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1"><AccordionTrigger>What does metabolic age mean?</AccordionTrigger><AccordionContent>Metabolic age is a comparison of your Basal Metabolic Rate (BMR) to the average BMR of people in your chronological age group. A metabolic age lower than your actual age suggests your metabolism is faster than average for your age group, which is often a positive sign. You can calculate your BMR separately with our <Link href="/bmr" className="text-primary hover:underline">BMR Calculator</Link>.</AccordionContent></AccordionItem>
              <AccordionItem value="item-2"><AccordionTrigger>How can I lower my metabolic age?</AccordionTrigger><AccordionContent>Lowering your metabolic age involves increasing your BMR. The most effective way to do this is by building more muscle mass through resistance training. A higher <Link href="/lean-body-mass" className="text-primary hover:underline">Lean Body Mass</Link> burns more calories at rest, leading to a "younger" metabolism.</AccordionContent></AccordionItem>
              <AccordionItem value="item-3"><AccordionTrigger>Is metabolic age a scientifically validated metric?</AccordionTrigger><AccordionContent>Metabolic age is more of a wellness concept than a clinical diagnostic tool. While it's based on your BMR, a real medical metric, the "age" part is an interpretation. It's a useful way to conceptualize your metabolic health, but metrics like <Link href="/body-fat" className="text-primary hover:underline">Body Fat Percentage</Link> are more concrete health indicators.</AccordionContent></AccordionItem>
              <AccordionItem value="item-4"><AccordionTrigger>My metabolic age is higher than my real age. Should I be worried?</AccordionTrigger><AccordionContent>It's not a cause for alarm, but it can be a useful wake-up call. It suggests your metabolism is slower than average for your age, which could be due to low muscle mass or a higher body fat percentage. Improving your body composition through diet and exercise will lower it. Our <Link href="/ffmi" className="text-primary hover:underline">FFMI Calculator</Link> can help you track muscularity.</AccordionContent></AccordionItem>
